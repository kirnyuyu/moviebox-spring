		                    ...
		                    <div class="detail-content-box">
		                        ...
		                        <input type="hidden" name="memberNo" value="${ loginUser.memberNo }" />
		                            ...
		                            <div id="category-box">
		                                ...
		                                <select name="noticeCategory" id="select-category">
		                            ...
		                            <div id="title-box">
		                                ...
		                                <input type="text" id="select-title" name="noticeTitle">
		                            </div>
		
		                            <div id="content-box">
		                                <div id="box-name">내용</div>
		                                <textarea id="select-content" cols="30" rows="10" name="noticeContent"></textarea>
		                            </div>
